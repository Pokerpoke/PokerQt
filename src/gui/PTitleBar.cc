#include "PokerQt/gui/PTitleBar.h"
#include "ui_PTitleBar.h"
#include <qicon.h>
#include <PokerQt/gui/HelperFunctions.h>
#include <PokerQt/base/Logger.h>

using namespace Poker;

PTitleBar::PTitleBar(QWidget *parent) : QWidget(parent), ui(new Ui::PTitleBar)
{
    ui->setupUi(this);
...
void PTitleBar::init()
{
    ...
    // connections
    connect(ui->window_title, &PWindowTitleButton::doubleClicked,
            [this]
            {
                on_maximum_clicked();
            });
